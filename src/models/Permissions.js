...
exports.add = function add(idFuncionario, gerirBolsista, gerirFuncionario, validarAgendamentos, confirmarVisita, gerarRelatorio, cadastrarAtracao, gerirBackup, gerirHorarioBolsista, gerirEscolas, callback){
    pool.getConnection(function(err, connection){
        if (err) throw err;
        var sql = "INSERT INTO permissoes (idFuncionario, gerirBolsista, gerirFuncionario,  confirmarVisita, gerarRelatorio,  cadastrarAtracao, gerirBackup, gerirHorarioBolsista, gerirEscolas) VALUES  ?"
        var values = [[idFuncionario, gerirBolsista, gerirFuncionario, validarAgendamentos, confirmarVisita, gerarRelatorio, inserirAtividade, cadastrarAtracao, gerirBackup, gerirHorarioBolsista, gerirEscolas]]
