...
exports.add = function add(idFuncionario, gerirBolsistas, gerirFuncionarios, validarAgendamentos, gerarRelatorio, inserirAtividade,gerirHorarioBolsista, gerirBackup, callback){
    pool.getConnection(function(err, connection){
        if (err) throw err;
        var sql = "INSERT INTO permissoes (idFuncionario, gerirBolsistas, gerirFuncionarios,  validarAgendamentos, gerarRelatorio, inserirAtividade, gerirHorarioBolsista, gerirBackup ) VALUES  ?"
        var values = [[idFuncionario, gerirBolsistas, gerirFuncionarios, validarAgendamentos, gerarRelatorio, inserirAtividade,gerirHorarioBolsista, gerirBackup]]
